        ...
        <div class="contact-grid-agile-w3s">
            <div class="col-md-4 contact-grid-agile-w3">
                <div class="contact-grid-agile-w31">
                    ...
                    <h4>Address</h4>
                    <p>12K Street, 45 Building Road, California</p>
                </div>
            </div>
            <div class="col-md-4 contact-grid-agile-w3">
            ...
            <div class="col-md-4 contact-grid-agile-w3">
                <div class="contact-grid-agile-w33">
                    ...
                    <h4>Email</h4>
                    <p><a href="mailto:martin.birisic.22.21@ict.edu.rs">martin.birisic.22.21@ict.edu.rs</a></p>
                </div>
            </div>
            ...
            <div class="agile-contact-left">
                <div class="col-md-6 address-grid">
                    ...
                    <div class="mail-agileits-w3layouts">
                        ...
                        <div class="contact-right">
                            <p>Telephone </p><span>0628323459</span>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="mail-agileits-w3layouts">
                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                        <div class="contact-right">
                            <p>Mail </p><a href="mailto:martin.birisic.22.21@ict.edu.rs">martin.birisic.22.21@ict.edu.rs</a>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="mail-agileits-w3layouts">
                ...
                <div class="col-md-6 contact-form">
                    ...
                    <form>
                        ...
                        <div class="styled-input">
                            <textarea rows="5" name="Message" id="contact-message"></textarea>
                            <label>Message</label>
                            <span></span>
                        </div>
                        <input class="btn mb-btn-action" type="button" name="btn-contact" id="btn-contact" value="SEND"/>
                        <div class="form-group mb-d-flex-center">
                            <p class="alert alert-info text-center mb-d-none" id="mb-contact-info"></p>
                        </div>
                    </form>
                </div>
            </div>
